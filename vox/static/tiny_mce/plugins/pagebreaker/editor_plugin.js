...
(function() {
	tinymce.create('tinymce.plugins.PageBreakPlugin', {
		init : function(ed, url) {
			var pb = '<img src="' + ed.theme.url + '/img/trans.gif" class="mcePageBreak mceItemNoResize" />', cls = 'mcePageBreak', sep = '<hr id="pagebreaker" />', pbRE;
		...
		getInfo : function() {
			return {
				...
				author : 'Moxiecode Systems AB. MadProgrammer edition',
				authorurl : '',
				infourl : '',
	...
	// Register plugin
	tinymce.PluginManager.add('pagebreaker', tinymce.plugins.PageBreakPlugin);
})();