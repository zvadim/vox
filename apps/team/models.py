...
class Member(models.Model):
    ...
    position = models.CharField(u'Должность', max_length=128, help_text=u'Точка с запятая (;) заменяется на перевод строки')
    ...
    photo = models.ImageField(u'Фото', upload_to='photo', help_text=u'Размер 200 на 200 px', null=True, default=True)
...
class Publication(models.Model):
    ...
    image = models.ImageField(u'Изображение', upload_to='publication', help_text=u'Точный размер - 600 на 400 px', blank=True, null=True)
    slug = models.SlugField()
    is_active = models.BooleanField(u'Показывать на сайте', default=True)
