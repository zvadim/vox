...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'team_publication', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Publication.title_uk'
        db.alter_column(u'team_publication', 'title_uk', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Publication.title_en'
        db.alter_column(u'team_publication', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Publication.title_ru'
        db.alter_column(u'team_publication', 'title_ru', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Publication.title'
        db.alter_column(u'team_publication', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Publication.title_uk'
        db.alter_column(u'team_publication', 'title_uk', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Publication.title_en'
        db.alter_column(u'team_publication', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Publication.title_ru'
        db.alter_column(u'team_publication', 'title_ru', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    models = {
        ...
        u'team.publication': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
